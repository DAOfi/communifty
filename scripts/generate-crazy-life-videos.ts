...
for (let i = 0; i < numTokens; ++i) {
  ...
  if (i < 48) {
    name = 'Crazy Life 1'
    image = external_url =
      'https://communifty.mypinata.cloud/ipfs/QmeDs5uyRMrirT5VfgeF8U8CpUbVTWV2j3fwJYtRBu767V'
    cl1++
  } else if (i < 75) {
    name = 'Crazy Life 2'
    image = external_url =
      'https://communifty.mypinata.cloud/ipfs/QmRg6vvqrJNdfGrATS8Tehaqm38jd6fs1ajxgE3GyzoKYW'
    cl2++
  } else {
    name = 'Crazy Life 3'
    image = external_url =
      'https://communifty.mypinata.cloud/ipfs/QmU1wB4GzVgPPB4agsKuErQsKJzsyRJ6ZCw2SaqLGurhzq'
    cl3++
  }
  ...
  fs.writeFileSync(
    `crazy_life_videos_metadata/${i + 1}`,
