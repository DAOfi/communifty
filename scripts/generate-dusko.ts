...
const descriptions: string[] = [
  ...
  'Spokesmodel is seen on billboards all over town selling cigarettes with catchy slogans like “I’m sending you a smoke signal, baby.”',
  ...
  'Sabrina is a drifter and traveled the desert by motorcycle, until it broke down outside of Dusko. Now she’s their newest hire! She may be reluctant to join the Dusko crew, but she’s without a doubt the strongest and smartest member of the team.',
  'Moon doesn’t mess around. She knows her order and wants to get out of the gas station as soon as possible.',
  ...
  'Chic is a junior executive. She appears to be the sweetest of all the Parafaze Corp. executives but that’s probably just an act…',
